...
class Album(object):
    ...
    def download(self):
        ...
        for track in tracks:
            track.download()
        scanUrl = "https://45-86-221-203.85a10a1b45914212a6c752a371b52176.plex.direct:12075/library/sections/7/refresh?path=" + urllib.parse.quote_plus(self.getPath()) + "&X-Plex-Token=Typea5Ncd-aJ8yp8x1VV"
        print(scanUrl)
